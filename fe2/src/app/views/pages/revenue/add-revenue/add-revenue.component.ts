...
export class AddRevenueComponent implements OnInit, OnDestroy {
	...
	createForm() {
		this.revenueForm = this.revenueFB.group({
			...
			remarks: [this.revenue.remarks, Validators.required],
		});
	}
	...
	reset() {
		this.revenue = Object.assign({}, this.oldRevenue);
		this.createForm();
		this.hasFormErrors = false;
		this.revenueForm.markAsPristine();
		this.revenueForm.markAsUntouched();
		this.revenueForm.updateValueAndValidity();
	}
