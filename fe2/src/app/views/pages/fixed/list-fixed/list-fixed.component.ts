...
import { FixedDeleted, FixedPageRequested} from '../../../../core/fixed/fixed.action';
import {FixedDataSource} from '../../../../core/fixed/fixed.datasource';
...
export class ListFixedComponent implements OnInit, OnDestroy {
	...
	displayedColumns = [ 'fixedAssetTypeName', 'fiscalFixedType','actions'];
	...
	onSubmit(){
		...
		this.http.post<any>('http://localhost:3000/api/excel/fixed/import', formData).subscribe(
			res =>{
