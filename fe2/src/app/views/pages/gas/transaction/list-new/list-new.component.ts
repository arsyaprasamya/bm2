...
export class ListNew implements OnInit, OnDestroy {
	...
	auto() {
		const API_WATER_TRANSACTION_URL = 'http://localhost:3000/api/gas/transaksi/posting';
	...
	onSubmit(){
		...
		this.http.post<any>('http://localhost:3000/api/excel/upload/gasconsumption', formData).subscribe(
			res =>{
