...
export class AddRateComponent implements OnInit, OnDestroy {
	...
	initWaterRate() {
		...
		// 	this.subheaderService.setTitle('Create water rate');
		// 	this.subheaderService.setBreadcrumbs([
		// 		{ title: 'Water Rate', page: `water-management/water/rate` },
		// 		{ title: 'Create Water Rate', page: `water-management/water/rate/add` }
		// 	]);
		// 	return;
		// }
		// this.subheaderService.setTitle('Edit water rate');
		// this.subheaderService.setBreadcrumbs([
		// 	{ title: 'Water Rate', page: `water-management/water/rate` },
		// 	{ title: 'Edit Water Rate', page: `water-management/water/rate/edit`, queryParams: { id: this.waterRate._id } }
		// ]);
	}
	createForm() {
		if(this.waterRate._id){
	...
	reset() {
		this.waterRate = Object.assign({}, this.oldWaterRate);
		this.createForm();
		this.hasFormErrors = false;
		this.waterRateForm.markAsPristine();
		this.waterRateForm.markAsUntouched();
		this.waterRateForm.updateValueAndValidity();
	}
