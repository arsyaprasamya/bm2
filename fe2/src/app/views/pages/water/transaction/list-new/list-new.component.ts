...
import {WaterTransactionDeleted, WaterTransactionPageRequested, WaterTransactionPageUnpost} from "../../../../../core/water/transaction/transaction.action";
...
export class ListNew implements OnInit, OnDestroy {
	...
	displayedColumns = ['select', 'watname', 'unit', 'startpos', 'endpos', 'billmonth', 'billamount', 'actions'];
	...
	auto() {
		const API_WATER_TRANSACTION_URL = 'http://localhost:3000/api/water/transaksi/posting';
