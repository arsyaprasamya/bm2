...
import { UomModel } from '../../../../core/uom/uom.model';
import { UomDeleted, UomPageRequested} from '../../../../core/uom/uom.action';
import {UomDataSource} from '../../../../core/uom/uom.datasource';
...
export class ListUomComponent implements OnInit, OnDestroy {
	...
	onSubmit(){
		...
		this.http.post<any>('http://localhost:3000/api/excel/uom/import', formData).subscribe(
			res =>{
