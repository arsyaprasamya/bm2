...
export class AddUomComponent implements OnInit, OnDestroy {
	...
	createForm() {
		this.uomForm = this.uomFB.group({
			uom: [this.uom.uom, Validators.required],
	...
	reset() {
		this.uom = Object.assign({}, this.oldUom);
		this.createForm();
		this.hasFormErrors = false;
		this.uomForm.markAsPristine();
