...
export class EditBlockComponent implements OnInit, OnDestroy {
	...
	// getListBlockGroup(qwr: QueryParamsModel) {
	// 	return this.service.getListBlockGroup(qwr).toPromise();
	// }
	...
	async loadBlockGroupList() {
		...
		// this.blockGroupResult = (await this.getListBlockGroup(queryParams)).data;
		// window.scrollTo(0,1)
