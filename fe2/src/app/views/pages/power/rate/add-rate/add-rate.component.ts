...
export class AddRateComponent implements OnInit, OnDestroy {
	...
	reset() {
		this.powerRate = Object.assign({}, this.oldPowerRate);
		this.createForm();
		this.hasFormErrors = false;
		this.powerRateForm.markAsPristine();
		this.powerRateForm.markAsUntouched();
		this.powerRateForm.updateValueAndValidity();
	}
