...
export class ListNew implements OnInit, OnDestroy {
	...
	displayedColumns = ['select', 'powname', 'unit', 'strtpos', 'endpos', 'billmnt', 'billamnt', 'actions'];
	...
	auto() {
		const API_WATER_TRANSACTION_URL = 'http://localhost:3000/api/power/transaksi/posting';
