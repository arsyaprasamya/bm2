...
export class ListTransactionComponent implements OnInit, OnDestroy {
	...
	displayedColumns = ['powname', 'unit', 'strtpos', 'endpos', 'billmnt', 'billamnt', 'actions'];
	...
	onSubmit(){
		...
		this.http.post<any>('http://localhost:3000/api/excel/upload/electricityconsumption', formData).subscribe(
			res =>{
