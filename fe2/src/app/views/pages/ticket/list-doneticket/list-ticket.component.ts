...
import { QueryTicketModel } from '../../../../core/ticket/queryticket.model';
...
export class ListDoneTicketComponent implements OnInit, OnDestroy {
	file;
	dataSource: TicketDataSource;
	displayedColumns = [ 'prnt','ticketId','subject', 'priority', 'status', 'createdDate','date_scheduled',  'actions'];
	...
	viewTicket(id) {
		this.router.navigate(['/ticket/view', id], { relativeTo: this.activatedRoute });
	}
	...
	onSubmit(){
		...
		this.http.post<any>('http://localhost:3000/api/excel/ticket/import', formData).subscribe(
			res =>{
