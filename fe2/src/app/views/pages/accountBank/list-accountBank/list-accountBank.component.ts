...
import { AccountBankModel } from '../../../../core/accountBank/accountBank.model';
import { AccountBankDeleted, AccountBankPageRequested} from '../../../../core/accountBank/accountBank.action';
import {AccountBankDataSource} from '../../../../core/accountBank/accountBank.datasource';
import {SubheaderService} from '../../../../core/_base/layout';
import {AccountBankService} from '../../../../core/accountBank/accountBank.service';
import { HttpClient } from '@angular/common/http';
import { NgbModal } from '@ng-bootstrap/ng-bootstrap';
import { QueryAccountBankModel } from '../../../../core/accountBank/queryaccountBank.model';
...
export class ListAccountBankComponent implements OnInit, OnDestroy {
	...
	private subscriptions: Subscription[] = [];
  	...
  	ngOnInit() {
		...
		**/
		...
		this.subheaderService.setTitle('Account Bank');
	...
	onSubmit(){
		...
		this.http.post<any>('http://localhost:3000/api/excel/accountBank/import', formData).subscribe(
			res =>{
