...
const API_EXCEL = 'http://localhost:3000/api/excel/owner/export';
const API_OWNERSHIP_URL = 'http://localhost:3000/api/contract/ownership';
const API_ALL_UNIT ='http://localhost:3000/api/contract';
...
export class OwnershipContractService {
	...
	getListOwnershipContract(queryParams: QueryOwnerTransactionModel): Observable<QueryResultsModel>{
		// return this.http.get<QueryResultsModel>(`${API_OWNERSHIP_URL}`);
