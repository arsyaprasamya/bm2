...
const API_RTLBILL_URL = 'http://localhost:3000/api/rentalbilling';
const API_CSV = 'http://localhost:3000/api/excel/rentalbilling/export';
...
export class RentalbillingService {
	...
	updateRentalbilling(rentalbilling: RentalbillingModel) {
		const url = `${API_RTLBILL_URL}/${rentalbilling._id}`;
